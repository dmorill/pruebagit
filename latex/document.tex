...
Sea $C_{ijk}$ los costos asociados de transporte, $O_{i}$ la oferta de la planta $i$, $D_k$ la demanda de los mercados $k$. Las variables de decisión se definen a continuación:
\begin{equation}
